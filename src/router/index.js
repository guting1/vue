...
import advertis from "@/views/admin/sms-home/advertise.vue"
import subjecta from "@/views/admin/cms/subject.vue"

import shop from "@/views/shop/shop.vue"

import login from "@/views/admin/login/login.vue" 
import shoping from "@/views/shop/shoping.vue" 
import cart from "@/views/shop/cart.vue" 
import cart1 from "@/views/shop/cart1.vue" 
//路由表
const routes = [
    {
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'advertis', name: 'advertis', component: advertis },
            { path: 'product', name: 'product', component: product },
            { path: 'subjecta', name: 'subjecta', component: subjecta },
        ]
    },
    // {
    //     path: '/adcate',
